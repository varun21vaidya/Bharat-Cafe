...
var userModel_1 = require("../DB/userModel");
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userModel_1.UserModel.countDocuments()];
            case 1:
                usersCount = _a.sent();
                if (usersCount > 0) {
                ...
                return [4 /*yield*/, userModel_1.UserModel.create(data_1.sample_users)];
            case 2:
                _a.sent();
...
router.put("/update", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, address, user, dbUser, updateduser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, userModel_1.UserModel.updateOne({ id: user.id }, { $set: {
                            name: name,
                            address: address,
                        } })];
            case 2:
